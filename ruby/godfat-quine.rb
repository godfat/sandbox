...
"Lin Jen Shin (godfat) is a programmer who works for Cardinal Blue Software, loving computer games, Haskell, open source, and self-referential jokes, such as: %p=~/(.+)/;puts(($1%%$1).sub(/^[^\"]+/,''))"=~/(.+)/;puts(($1%$1).sub(/^[^"]+/,''))
